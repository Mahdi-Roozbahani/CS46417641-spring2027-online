...
For both course levels, show the actual output, say what it means, explain what did not work, and identify what you will improve. A model listed in a plan but not run does not meet this checkpoint. See the [worked example](../#one-example-across-stages).
